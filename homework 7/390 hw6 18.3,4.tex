...
\begin{document}
% >>==========|| 18.3 ||==========<<
\tbo{Exercise 18.3} Suppose you had an \( (s, t) \)-flow \( f \). \label{ex:18.3}
...
% >>==========|| 18.4 ||==========<<
\tbo{Exercise 18.4} This exercise develops a \( O((m\sq + mn\log(n))\log(\lambda)) \)-time algorithm for maximum \( (s,t) \)-flow and builds on ideas from exercise \hyperref[ex:18.3]{18.3}.
